...
extern "C"
{
    @interface PropellerSDK (Private)
        ...
        + (BOOL)useDebugServers:(NSString *)sdkURL fuelAPIURL:(NSString *)fuelAPIURL tournamentAPIURL:(NSString *)tournamentAPIURL challengeAPIURL:(NSString *)challengeAPIURL cdnAPIURL:(NSString *)cdnAPIURL transactionAPIURL:(NSString*)transactionAPIURL dynamicsAPIURL:(NSString*)dynamicsAPIURL;

    @end
    
    bool iOSUseDebugServers(const char* sdkHost, const char* apiHost, const char* tournamentHost, const char* challengeHost, const char* cdnHost, const char* transactionHost, const char* dynamicsHost)
    {
        ...
        return [PropellerSDK useDebugServers:sdkURL
