...
extern "C"
{
    ...
    + (void) initializeDebug:(NSString*)gameKey gameSecret:(NSString*)gameSecret gameHasLogin:(BOOL)hasLogin gameHasInvite:(BOOL)hasInvite gameHasShare:(BOOL)hasShare
    {
        ...
        if ([env isEqualToString:@"Internal"]) {
            gameKey = @"5522ed09663330000b090000";
            gameSecret = @"62363bb2-cecc-a2bc-694c-5e5e532a214f";
            ...
            gameKey = @"5477a6c17061701423190000";
            gameSecret = @"bc8939af-ac67-de48-7791-a4dc76ac3cfe";
            ...
            gameKey = @"542b3bec636f62427de7ac00";
            gameSecret = @"7944a1a9-fc41-8789-4c67-dc98bb4c1743";
